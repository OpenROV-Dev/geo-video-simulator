...
//  var ffmpeg_options = '-threads 1 -f lavfi -re -i mandelbrot=s=1920x1080:start_scale=1.689­12323178293021:end_pts=212:maxiter=42192­342 -f mp4 -g 1 -threads 2 -movflags empty_moov+default_base_moof+frag_keyframe -profile:v main -level 30 -pix_fmt yuv420p -tune zerolatency -';
